...
namespace RickEditor.Editor{
	...
	public class RickEditorGUI : CustomEditorBase {
		...
		#region FilePath
		public static string FilePath(GUIContent label, string path, string relativeTo, string extension = null, bool keepExtention = false){
			Rect rect = getBaseRect();
		...
		public static string FilePath(string labelText, string path, string relativeTo, string extension = null, bool keepExtention = false){
			return FilePath(new GUIContent(labelText), path, relativeTo, extension, keepExtention);
		}
		
		private static string FilePathButton(Rect rect, string path, string relativeTo, string extension) {
